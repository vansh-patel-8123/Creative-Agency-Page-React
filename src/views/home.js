    ...
    <div className="home-container">
      ...
      <div className="section-container">
        <div className="max-content-container">
          <div className="home-top-part">
            ...
            <div className="home-subscribe-container">
              ...
              />
              <button className="home-button2 button-primary button">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <footer className="home-max-width8 max-content-container">
          <img
            alt="image"
            src="/playground_assets/default-2-200h.png"
            className="home-image6"
          />
          <span className="home-text83">
            <span>All rights recived @ onBoard</span>
            ...
            <span className="home-text87">techshark.in</span>
            <span> </span>
          </span>
        </footer>
      </div>
